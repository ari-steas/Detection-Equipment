...
{
    internal class AntennaControls : TerminalControlAdder<IffReflectorBlock, IMyRadioAntenna> // separate class is needed because IMyFunctionalBlock can't have terminal controls added
    {
