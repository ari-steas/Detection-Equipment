...
namespace DetectionEquipment.Shared.BlockLogic.ControlBlocks.Aggregator
{
        ...
        protected override void CreateTerminalActions()
        {
            ...
            ActiveSensorSelect = new BlockSelectControl<AggregatorBlock, IMyConveyorSorter>(
                ...
                logic => MyAPIGateway.Session.IsServer ?
                         ...
                         (IEnumerable<IMyCubeBlock>)SensorBlockManager.GridBlockSensorsMap.GetValueOrDefault(logic.CubeBlock.CubeGrid, new HashSet<IMyCubeBlock>()),
                (logic, selected) =>
                {
