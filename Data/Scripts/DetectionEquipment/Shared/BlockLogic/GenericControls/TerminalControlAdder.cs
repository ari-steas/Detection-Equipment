...
namespace DetectionEquipment.Shared.BlockLogic.GenericControls
{
    ...
    internal abstract class TerminalControlAdder<TBlockType>
        where TBlockType : IMyTerminalBlock, IMyFunctionalBlock
    {
        private static HashSet<string> _doneIds = new HashSet<string>();
        protected abstract Func<IMyTerminalBlock, bool> VisibleFunc { get; }
        ...
        protected bool IsDone
        {
            get
            {
                return _doneIds.Contains(IdPrefix);
            }
            set
            {
                _doneIds.Add(IdPrefix);
            }
        }
        ...
        public virtual void DoOnce()
        {
            ...
            IsDone = true;
            Log.Info(GetType().Name, $"Created terminal actions and properties for {typeof(TBlockType).Name}/{IdPrefix}.");
        }

        protected abstract void CreateTerminalActions();
        protected abstract void CreateTerminalProperties();

        public IMyTerminalControlOnOffSwitch CreateToggle(string id, string displayName, string toolTip, Func<IMyTerminalBlock, bool> getter, Action<IMyTerminalBlock, bool> setter)
        {
        ...
        public IMyTerminalControlSlider CreateSlider(string id, string displayName, string toolTip, float min, float max, Func<IMyTerminalBlock, float> getter, Action<IMyTerminalBlock, float> setter, Action<IMyTerminalBlock, StringBuilder> writer)
        {
        ...
        public IMyTerminalControlButton CreateButton(string id, string displayName, string toolTip, Action<IMyTerminalBlock> action)
        {
        ...
        public IMyTerminalControlCheckbox CreateCheckbox(string id, string displayName, string toolTip, Func<IMyTerminalBlock, bool> getter, Action<IMyTerminalBlock, bool> setter)
        {
        ...
        public IMyTerminalControlCombobox CreateCombobox(string id, string displayName, string toolTip, Action<List<MyTerminalControlComboBoxItem>> content, Func<IMyTerminalBlock, long> getter, Action<IMyTerminalBlock, long> setter)
        {
        ...
        public IMyTerminalControlListbox CreateListbox(string id, string displayName, string toolTip, bool multiSelect, Action<IMyTerminalBlock, List<MyTerminalControlListBoxItem>, List<MyTerminalControlListBoxItem>> content, Action<IMyTerminalBlock, List<MyTerminalControlListBoxItem>> itemSelected)
        {
        ...
        public IMyTerminalControlTextbox CreateTextbox(string id, string displayName, string toolTip, Func<IMyTerminalBlock, StringBuilder> getter, Action<IMyTerminalBlock, StringBuilder> setter)
        {
        ...
        public IMyTerminalControlSeparator CreateSeperator(string id)
        {
        ...
        /// <returns></returns>
        public IMyTerminalAction CreateAction(string id, string displayName, Action<IMyTerminalBlock> action, Action<IMyTerminalBlock, StringBuilder> writer, string icon)
        {
        ...
        /// <returns></returns>
        public IMyTerminalControlProperty<TValue> CreateProperty<TValue>(string id, Func<IMyTerminalBlock, TValue> getter, Action<IMyTerminalBlock, TValue> setter)
        {
